            ...
            <div className="filter-modal mt-16 bg-blue-one h-fit w-4/5 max-w-md rounded">
                <div className="edit-modal-content bg-blue-five border-2 border-blue-two rounded pb-3">
                    ...
                    <header className="p-3 flex justify-between items-center bg-blue-five rounded-t mb-5 border-b border-blue-two">
                        ...
                        <Button className="bg-blue-two p-2 rounded hover:bg-blue-three" btnTask={closeModal} btnContent={<FaXmark />} /> 
                    </header>
                    <form className="text-center flex flex-col" onSubmit={(e) => filterForm([e, tagChoice, timeChoice, ])}>
                        ...
                        <Button className="bg-blue-two w-3/6 m-auto py-1 rounded my-5 hover:bg-blue-three" type="submit" btnContent="Submit" />
